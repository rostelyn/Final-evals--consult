    ...
    <table class="bsit-course-student-list">
        ...
        <tbody>
            @foreach($students as $student)
                @if($student->Course_Strand === 'Grade11' && $student->Grade_Level_Section === 'Lovelace')
                    <tr>
                        <td>{{ $student->name }}</td>
                        <td>
                            <a href="{{ route('student.show', ['id' => $student->StudentId, 'grade' => 'Lovelace']) }}">

...
<head>
    ...
    <title>Grade 11 Pythagoras/Aristotle Students</title>
</head>
<body>
    <div class="header">
        <h1>STUDENT EVALUATION AND CONSULTATION</h1>
    </div>
    <h2>Grade 11 Pythagoras/Aristotle </h2>
    ...
    <table class="bsit-course-student-list">
        ...
        <tbody>
            @foreach($students as $student)
                @if($student->Course_Strand === 'Grade11' && $student->Grade_Level_Section === 'Aristotle')
                    <tr>
                        <td>{{ $student->name }}</td>
                        <td>
